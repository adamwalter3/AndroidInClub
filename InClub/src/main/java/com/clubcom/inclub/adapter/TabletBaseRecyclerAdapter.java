...
public class TabletBaseRecyclerAdapter extends BaseRecyclerAdapter {
    public TabletBaseRecyclerAdapter(BaseActivity baseActivity, List<? extends GridViewItem> items, int layout, MenuFragment.OnItemClickListener listener) {
        super(baseActivity, items, layout, listener);
    }

    public TabletBaseRecyclerAdapter(BaseActivity baseActivity, List<? extends GridViewItem> items, int layout) {
